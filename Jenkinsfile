  ...
  stages {
    ...
    post {  
         ...
         success {   
            ...
            emailext attachLog: true, body: "<b>Example</b><br>Project: ${env.JOB_NAME}", from: 'networksnts@gmail.com',compressLog: true, mimeType: 'text/html', replyTo: '', subject: "Deploy Successfull Project ${env.JOB_NAME}", to: "networksnts@gmail.com;ramji013@gmail.com";
         }  
         failure {  
